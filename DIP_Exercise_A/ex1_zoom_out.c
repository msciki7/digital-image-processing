...
/* ── Exercise 1: Zoom-out 1/2 (512x512 → 256x256) ── */
...
int main(void) {
    ...
    uint8** output = zoom_out_half(lena);
    write_bmp("output_1_zoom_out.bmp", output, 256, 256);
    free_2d(lena);
    free_2d(output);
    printf("output_1_zoom_out.bmp 생성 완료 (256x256)\n");
    return 0;
}
